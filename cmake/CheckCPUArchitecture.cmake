...
function(check_cpu_architecture ARCH VARIABLE)
  ...
  elseif(ARCH MATCHES "powerpc64|ppc64")
    _internal_check_cpu_architecture("defined(__PPC64__) || defined(__powerpc64__) || defined(__ppc64__)" powerpc64 ${VARIABLE})
  elseif(ARCH MATCHES "powerpc32|ppc")
    _internal_check_cpu_architecture("(defined(__PPC__) || defined(__powerpc__) || defined(__ppc__)) && !defined(__powerpc64__)" powerpc32 ${VARIABLE})
  else()
